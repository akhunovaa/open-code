 ...
 * просмотра транзакций и оффлайн-отправки средств. Сеть задаётся свойством
 * {@code btc.network} (по умолчанию {@code mainnet}). Кошельки сериализуются
 * в protobuf-файлы в каталоге хранения
 * (свойство {@code btc.storage-dir}, по умолчанию {@code /data}).</p>
 *
...
public class BitcoinWalletController {
     ...
     *
     * <p>Сканирует каталог хранения и возвращает
     ...
     * пользователя в каталоге хранения. Если кошелёк
