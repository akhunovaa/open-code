 ...
 * {@code mainnet} и сериализуются в protobuf-файлы в каталоге
 * {@code /data}.</p>
 *
...
public class BitcoinWalletController {
     ...
     *
     * <p>Сканирует каталог хранения {@code /data} и возвращает
     ...
     * пользователя в каталоге {@code /data}. Если кошелёк
